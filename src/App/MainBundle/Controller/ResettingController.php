...
class ResettingController extends ContainerAware
{
    ...
    {
        return $this->container->get('templating')->renderResponse('AppMainBundle:Resetting:request.html.' . $this->getEngine());
    }
    ...
    public function resetAction($token)
    {
        ...
        return $this->container->get('templating')->renderResponse('AppMainBundle:Resetting:reset.html.' . $this->getEngine(), array(
            'token' => $token,
    ...
    {
        try {
            $this->container->get('fos_user.security.login_manager')->loginUser($this->container->getParameter('fos_user.firewall_name'), $user, $response);
