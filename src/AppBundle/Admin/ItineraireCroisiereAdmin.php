...
{    // Fields to be shown on create/edit forms
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->add('dateDebut', 'sonata_type_date_picker', array('label' => 'Date début: ', 'required'=> false)) 
            ->add('dateFin', 'sonata_type_date_picker', array('label' => 'Date fin: ', 'required'=> false)) 
            ->add('itineraire', 'entity', array(
                'class'    => 'AppBundle\Entity\Itineraire',
                'label'    => "Itineraire: "
            )) 
            ->add('variationPrix', 'text', array('label' => 'Variation prix: ', 'required'=> false))
            ->add('tarifAppliqueSur', 'choice', array('label' => 'Tarif à appliquer sur: ', 'required' => false,'choice_list' => $this->loadChoiceList("tarifAppliqueSur")))
